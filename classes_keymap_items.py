...
keymap_items = {   
        ...
        'DOUBLE_CLICK_SELECT_ISLAND': [{'label': 'Select Mesh island', 'keymap': 'Mesh', 'idname': 'keyops.double_click_select_island', 'type': 'LEFTMOUSE', 'value': 'DOUBLE_CLICK'},
                                       {'label': 'Extended Select Mesh islands', 'keymap': 'Mesh', 'idname': 'keyops.double_click_select_island', 'type': 'LEFTMOUSE', 'value': 'DOUBLE_CLICK', 'shift': True, 'properties': [('deselect', False)]},
                                       {'label': 'Extended deselect Mesh islands', 'keymap': 'Mesh', 'idname': 'keyops.double_click_select_island', 'type': 'LEFTMOUSE', 'value': 'DOUBLE_CLICK', 'ctrl': True, 'properties': [('deselect', True)]},
                                       {'label': 'Select UV island', 'keymap': 'UV Editor', 'idname': 'keyops.double_click_select_island', 'type': 'LEFTMOUSE', 'value': 'DOUBLE_CLICK'},
